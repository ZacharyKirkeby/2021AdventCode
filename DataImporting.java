...
public static ArrayList<HydroPoints> makeList(ArrayList<String> words){
ArrayList<HydroPoints> onlyPoints = new ArrayList<>();
for(int i=0; i < words.size(); i++){
      ...
      temp = data.substring(0,c);
       ...
       HydroPoints point = new HydroPoints(x1, y1, x2,y2);
